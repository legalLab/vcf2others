...
package rather than importing the genlight object. The function
[`vcf2migrate()`](https://legallab.github.io/vcf2others/reference/vcf2migrate.md)
generates several different types of SNP compatible formats. Beerli
recommends treating linked SNP blocks as short sequences that have
invariant sites removed, since available models for alleles are better
than for SNPs. Thus linked blocks are indicated as (s100) rather than
(n100).
